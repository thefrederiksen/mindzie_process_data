#!/usr/bin/env python3
"""
Source to Pay Historical Dataset Upload Script
Uploads the historical dataset CSV to Mindzie Studio
"""
...
def main():
    ...
    csv_path = os.path.join(output_dir, 'source_to_pay_historical.csv')
    dataset_name = 'Source to Pay Historical'
